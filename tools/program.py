    ...
    for epoch in range(start_epoch, epoch_num + 1):
        ...
        for idx, batch in enumerate(train_dataloader):
            ...
            if cal_metric_during_train:  # only rec and cls need
                ...
                # if idx == 0:
                #     for i in range(len(post_result[0])):
                #         print(post_result[0][i][0], post_result[1][i][0])
...
def eval_distill(model, valid_dataloader, post_process_class, eval_class,
                 use_srn=False):
    model.eval()
    with paddle.no_grad():
        total_frame = 0.0
